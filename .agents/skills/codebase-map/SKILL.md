...
tests/            # black-box app test suite (bun test + agent-browser); mirrors the repo (tests/api/hono, tests/web/next), canonical repo only (stripped from forks via .gitpickignore)
```
