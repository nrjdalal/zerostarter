...
const svg = rendered
  ...
  .replaceAll('fill="black"', 'fill="#1f6feb"')
  .replace(/stroke="[^"]*"/g, 'stroke="#1f6feb"')
  .replace(/stroke:[^;]*;/g, "stroke:#1f6feb;")
  .replace(/<text([^>]*)>/g, '<text$1 fill="#1f6feb">')
  .replaceAll('stroke="#1f6feb" points="-4,4', 'stroke="none" points="-4,4')
