...
- [Move the client split decision to build time](build-time-split-decision.md) - stop shipping the suffix predicate to the browser, then decide tldts vs the curated set (#720 review).
