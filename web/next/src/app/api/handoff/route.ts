import { HANDOFF_NONCE_COOKIE } from "@packages/auth/handoff"
...
// The claim route mounts only in split mode, matching the api's handoff gate; NEXT_PUBLIC_DEPLOY_MODE is baked at build (see @packages/env/deploy), so this is a constant.
