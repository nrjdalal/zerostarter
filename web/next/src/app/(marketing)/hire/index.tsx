...
export const Route = createFileRoute("/(marketing)/hire/")({
  head: () => ({
    meta: [
      { title: `Neeraj Dalal | ${site.name}` },
      {
        name: "description",
        content:
      ...
      { property: "og:image:alt", content: "Neeraj Dalal - AI-native product engineer" },
    ...
    projects: [
      {
        href: config.app.url,
        title: "ZeroStarter",
        description: "Production-ready SaaS infrastructure with world-class human and agent DX.",
        external: false,
      },
    ],
  },
    ...
    <main className="bg-background text-foreground min-h-svh space-y-16 py-24 text-lg">
      ...
      <div className="container mx-auto max-w-3xl space-y-8 px-4 md:px-6">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Link to="/resume" className={buttonClass}>
