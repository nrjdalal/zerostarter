...
The global CSS imports Tailwind and animations; fonts are self-hosted via `next/font/local` (see `web/next/src/lib/fonts.ts`), with the theme's font roles chaining to the generated CSS variables:
