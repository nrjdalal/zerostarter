...
| `waitlist`     | `/waitlist` page and its API, plus Console > Waitlist and `/api/v1/admin/waitlist*`       | `/waitlist`, `/api/waitlist` and the console page 404, the nav drops it, and a fresh fork's home becomes a plain landing page |
