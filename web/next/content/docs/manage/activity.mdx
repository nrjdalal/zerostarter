...
title: Activity
description: "A readable trail of every console write: who changed a role, banned an account, edited the allowlist, or removed a signup."
---
...
| Field       | Holds                                                                                                          |
| ----------- | -------------------------------------------------------------------------------------------------------------- |
| `action`    | what happened: `role.change`, `user.ban`, `user.unban`, `allowlist.add`, `allowlist.remove`, `waitlist.remove` |
...
| Removed signup | `Removed ada@example.com from the waitlist`                                                                                                                         |
