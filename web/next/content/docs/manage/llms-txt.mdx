...
- [llms.txt]({config.app.url}/llms.txt) - Index for complete documentation for {config.app.name}
- [blog.md]({config.app.url}/blog.md) - Index for latest articles and updates about {config.app.name}
- [llms-full.txt]({config.app.url}/llms-full.txt) - Complete documentation in one page for AI assistants
