...
In development, `curl http://zerostarter.localhost:1355/llms-full.txt` hands an agent the whole project as one file before it writes a line, which is exactly what the `codebase-map` skill does to orient.
