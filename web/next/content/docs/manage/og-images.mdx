...
ZeroStarter generates dynamic Open Graph images for social media previews using [@takumi-rs/image-response](https://github.com/vercel/og-image). Each page type has its own OG image route.
