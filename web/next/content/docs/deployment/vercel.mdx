...
| Frontend | `web/next`     | TanStack Start |
...
3. Add the frontend env vars, using the backend URL from above for `VITE_API_URL`.
4. Deploy.

```
NODE_ENV=production
VITE_APP_URL=https://your-web.vercel.app
VITE_API_URL=https://your-api.vercel.app
# Optional analytics / feedback
VITE_POSTHOG_HOST=https://eu.i.posthog.com
VITE_POSTHOG_KEY=your_posthog_key
VITE_USERJOT_URL=your_userjot_url
```

`VITE_NODE_ENV` is required by the web env schema but derived from `NODE_ENV`, so you don't set it separately.
