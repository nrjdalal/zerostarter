...
<Callout type="warn">
  ...
  the update and are listed by name; anything you meant to keep is still in the diff (`git checkout`
  restores it). From the next sync on, your edits are preserved automatically.
</Callout>
