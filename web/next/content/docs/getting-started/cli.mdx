...
- a skill you authored (`source: local`) or took from another upstream is never touched, and never restamped as coming from here
- a skill the starter vendored from a tool keeps that tool as its `source`, so you re-vendor it the same way and it stays in your **Vendored** table
