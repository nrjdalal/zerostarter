...
A fork scaffolded before the guide shipped has the short stub older CLIs wrote. If that stub is untouched, the next sync replaces it with the full guide. If you have written your own rules into it, sync leaves it alone; to take the starter's guide, delete `AGENTS.md`, commit, and sync again.
