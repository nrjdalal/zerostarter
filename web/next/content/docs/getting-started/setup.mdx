...
- **web** (Next.js) on [http://zerostarter.localhost:1355](http://zerostarter.localhost:1355), served through portless (branch-prefixed in a worktree; `http://localhost:3000` under `PORTLESS=0`)
- **api** (Hono) on [http://api.zerostarter.localhost:1355](http://api.zerostarter.localhost:1355), with an interactive API reference at [/api/docs](http://api.zerostarter.localhost:1355/api/docs)
