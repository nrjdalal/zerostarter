...
See [The CLI](/docs/getting-started/cli) for every flag, what each rolls back when a step fails, exactly what `sync` preserves, and how it treats the skills and the agent guide you have edited.
