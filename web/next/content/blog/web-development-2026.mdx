...
> **Try it yourself:** Clone ZeroStarter and run `bun dev` - authentication with GitHub and Google OAuth is ready to configure. See the [Installation guide](/docs/getting-started/setup#authentication-setup).
