...
Skills you own are preserved too: one you authored, one vendored from a tool, or one you edited keeps your version and its own `source`, and sync names it in the summary rather than replacing it.
