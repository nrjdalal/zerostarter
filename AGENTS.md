...
- ALWAYS: Follow `DESIGN.md` (repo root) for UI, styling, and design decisions; the `design` skill surfaces it. Update `DESIGN.md` in the same change when a convention changes.
