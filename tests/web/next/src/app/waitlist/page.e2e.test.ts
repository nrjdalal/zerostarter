...
// The public waitlist page in web/next/src/app/waitlist/page.tsx on a running stack: it renders. Skipped unless E2E_API_URL and E2E_WEB_URL name a stack (bun run test:e2e).
