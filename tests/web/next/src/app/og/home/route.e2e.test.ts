...
// The home Open Graph image in web/next/src/app/og/home/route.tsx on a running stack: a PNG. Skipped unless E2E_API_URL and E2E_WEB_URL name a stack (bun run test:e2e).
