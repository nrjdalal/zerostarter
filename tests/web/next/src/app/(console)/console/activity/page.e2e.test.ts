...
// The activity page in web/next/src/app/(console)/console/activity/page.tsx on a running stack: the owner gets it. Skipped unless E2E_API_URL and E2E_WEB_URL name a stack (bun run test:e2e).
